...
<div id="sidebarMain" class="d-none">
    <aside
        ...
        <div class="navbar-vertical-container">
            ...
            {{\Illuminate\Support\Str::limit(auth('vendor')->user()->restaurants[0]->name,15)}}
            <!-- End Logo -->
                                ...
                                <a class="nav-link " href="{{route('vendor.order.list',['confirmed'])}}" title="{{__('messages.confirmed')}}">
                                    ...
                                    <span class="text-truncate">
                                        {{__('messages.confirmed')}}
                                            <span class="badge badge-soft-success badge-pill ml-1">
                                            {{\App\Models\Order::where(['order_status'=>'confirmed','restaurant_id'=>\App\CentralLogics\Helpers::get_restaurant_id()])->count()}}
                                        </span>
                                    </span>
                                </a>
                            </li>
