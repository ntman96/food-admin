                    ...
                    <div class="card-body">
                        <form action="{{isset($addon)?route('admin.addon.update',[$addon['id']]):route('admin.addon.store')}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select name="restaurant_id" class="js-data-example-ajax form-control"  data-placeholder="{{__('messages.select')}} {{__('messages.restaurant')}}" oninvalid="this.setCustomValidity('{{__('messages.please_select_restaurant')}}')">
 
                                </select>
                            </div>
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">{{__('messages.name')}}</label>
                                <input type="text" name="name" class="form-control" placeholder="New addon" value="{{old('name')}}" required>
                            </div>
                            <div class="form-group">
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-header-title"> {{__('messages.addon')}} {{__('messages.list')}}</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="col-md-4 mb-3 mb-md-0">
                                <form id="search-form">
                                    ...
                                    <div class="input-group input-group-merge input-group-flush">
                                        ...
                                        <input id="datatableSearch" type="search" name="search" class="form-control" placeholder="Search addons" aria-label="Search addons">
                                    </div>
                                    <!-- End Search -->
                                </form>
                            </div>
