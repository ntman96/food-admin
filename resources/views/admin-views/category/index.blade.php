                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{isset($category)?route('admin.category.update',[$category['id']]):route('admin.category.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>{{__('messages.image')}}</label><small style="color: red">* ( {{__('messages.size')}} 600 X 200 pixel )</small>
            ...
            <div class="col-md-7">
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>{{__('messages.category')}} {{__('messages.list')}}<span class="badge badge-soft-dark ml-2" id="itemCount">{{$categories->count()}}</span></h5>
                        <form id="dataSearch">
                            @csrf
                            <!-- Search -->
