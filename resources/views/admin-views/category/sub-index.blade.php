                    ...
                    <div class="card-body">
                        ...
                        @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{isset($category)?$category['name']:''}}"  class="form-control" placeholder="New Sub Category"
                                    required>
                            </div>
                    ...
                    <div class="card-header pb-0">
                        ...
                        <form>
                            ...
                            <div class="input-group input-group-merge input-group-flush">
                                ...
                                <input id="datatableSearch" type="search" class="form-control" placeholder="Search sub categories" aria-label="Search sub categories">
                            </div>
                            <!-- End Search -->
                        </form>
                    </div>
                        ...
                        <div class="table-responsive datatable-custom">
                            <table id="columnSearchDatatable"
                                ...
                                <thead class="thead-light">
                                    <tr>
                                        <th>{{__('messages.#')}}</th>
                                        <th style="width: 50%">{{__('messages.main')}} {{__('messages.category')}}</th>
