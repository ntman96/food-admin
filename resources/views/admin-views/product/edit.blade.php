                ...
                <form action="javascript:" method="post" id="product_form"
                    ...
                    <div class="row">
                        ...
                        {{--<div class="col-md-3 col-6">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">{{__('messages.item')}} {{__('messages.type')}}</label>
                                <select name="item_type" class="form-control js-select2-custom">
                                    <option value="0" {{$product['set_menu']==0?'selected':''}}>{{__('messages.food_item')}}</option>
                                    <option value="1" {{$product['set_menu']==1?'selected':''}}>{{__('messages.set_menu')}}</option>
                                </select>
                            </div>
                        </div>--}}
                        <div class="col-md-4 col-6">
...
@push('script_2')
    <script>
        ...
        $(document).ready(function () {
            ...
            getRequest('{{url('/')}}/admin/vendor/get-addons?restaurant_id={{$product['restaurant_id']}}@foreach(json_decode($product['add_ons'], true) as $addon)&data[]={{$addon}}@endforeach','add_on');
        });
    </script>
