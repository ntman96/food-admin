                            ...
                            <div class="row">
                                <div class="col-6 border-right">
                                    <ul class="list-unstyled list-unstyled-py-3 text-dark mb-3">
                                        <li class="pb-1 pt-1">{{__('messages.start')}} {{__('messages.date')}} : {{$restaurant->discount?$restaurant->discount->start_date->format('Y-m-d'):''}}</li>
                                        <li class="pb-1 pt-1">{{__('messages.end')}} {{__('messages.date')}} : {{$restaurant->discount?$restaurant->discount->end_date->format('Y-m-d'):''}}</li>
                                        <li class="pb-1 pt-1">{{__('messages.start')}} {{__('messages.time')}} : {{$restaurant->discount?$restaurant->discount->start_time->format('h:i:s A'):''}}</li>
                                        <li class="pb-1 pt-1">{{__('messages.end')}} {{__('messages.time')}} : {{$restaurant->discount?$restaurant->discount->end_time->format('h:i:s A'):''}}</li>
                                    </ul>
                                </div>
                                <div class="col-6">
                                    <ul class="list-unstyled list-unstyled-py-3 text-dark mb-3">
            ...
            <div class="row">
                <div class="col-md-6 col-6">
                    <div class="form-group">
                        ...
                        <input type="date" id="date_from" class="form-control" required name="start_date" value="{{$restaurant->discount?$restaurant->discount->start_date->format('Y-m-d'):''}}"> 
                    </div>
                </div>
                <div class="col-md-6 col-6">
                    <div class="form-group">
                        <label class="input-label" for="title">{{__('messages.end')}} {{__('messages.date')}}</label>
                        <input type="date" id="date_to" class="form-control" required name="end_date" value="{{$restaurant->discount?$restaurant->discount->end_date->format('Y-m-d'):''}}">
                    </div>
                ...
                <div class="col-md-6 col-6">
                    <div class="form-group">
                        ...
                        <input type="time" id="start_time" class="form-control" required name="start_time" value="{{$restaurant->discount?$restaurant->discount->start_time->format('H:i:s'):'00:00'}}">
                    </div>
                </div>
                <div class="col-md-6 col-6">
                    <label class="input-label" for="title">{{__('messages.end')}} {{__('messages.time')}}</label>
                    <input type="time" id="end_time" class="form-control" required name="end_time" value="{{$restaurant->discount?$restaurant->discount->end_time->format('H:i:s'):'23:59'}}">
                </div>
            </div>
            <div class="row">
