...
class DashboardController extends Controller
{
    ...
    public function order_stats_calc($restaurant_ids)
    {
        ...
        if ($params['statistics_type'] == 'today') {
            ...
            $refund_requested = Order::RefundRequest();
    ...
    public function dashboard_data()
    {
        ...
        $popular = Wishlist::with(['restaurant'])->whereIn('restaurant_id', $restaurant_ids)->select('restaurant_id', DB::raw('COUNT(restaurant_id) as count'))->groupBy('restaurant_id')->orderBy('count', 'DESC')->get();
