...
class DeliverymanController extends Controller
{
    ...
    public function get_profile(Request $request)
    {
        ...
        $dm['order_count'] =$dm->orders->count();
        $dm['todays_order_count'] =$dm->todaysorders->count();
        $dm['this_week_order_count'] =$dm->this_week_orders->count();
        $dm['member_since_days'] =$dm->created_at->diffInDays();
